...
-- Tiempo de generación: 06-09-2023 a las 00:29:49
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `authenticate` (IN `p_username` VARCHAR(50), IN `p_password` VARCHAR(50))  BEGIN
    SELECT EXISTS(
        SELECT *
        FROM `user`
